...
int DLL_EXPORT  MosaicWithDEM(char* nvmFile, char* outFile, char* mainPath);


//using bundler's output 
//int DLL_EXPORT MosaicOnBundleWithDEM(char* imageListFile, char* bundleFile, char* posFile, char* outFile, int nLevel);
